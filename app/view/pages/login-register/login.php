...
<section class="contrato">
    ...
    <form action="<?php echo URL_PROJECT ?>/home/login" class="contact" method="POST">
        ...
        <input type="email" class="form-control" id="email" name="correo" placeholder="micorreo@gmail.com"
            required /><br>
        <label class="form-label" for="contrasena">CONTRASEÑA:</label>
        <input type="password" class="form-control" id="email" name="contrasena" placeholder="contraseña"
            required /><br>
